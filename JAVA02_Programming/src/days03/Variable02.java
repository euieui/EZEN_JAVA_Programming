...
import java.util.Scanner; // --- 추가가 됨
...
public class Variable02 {
	...
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in); // 화면 입력을 위한 준비 코드 --- sc도 내가보기엔 변수
		System.out.printf("정수 하나를 입력해주세요. num1 : ");
		...
		System.out.printf("두번째 정수를 입력해주세요. num2 : ");
		num2 = sc.nextInt();
