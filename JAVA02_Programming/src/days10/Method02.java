...
public class Method02 {
	...
	// 메서드 몸체에서 괄호안에 위치하며 전달된 값을 받아주는 변수 : 매개 변수
	// 매개 변수의 선언
	// public static void 메서드 이름(자료형 매개변수, 자료형 매개변수 ...){
	
	// }  매개변수 또한 필요한 갯수 만큼 선언해서 사용할 수 있습니다
	...
	public static void main(String[] args) {
		myPrint(100); 
		//100 : 전달 인수 -> 괄호 안에 전달된 인수는 메서드가 실행될때 
		// 괄호안에 선언된  n변수에 저장합니다.
		myPrint(200);
	...
	// 전달인수는 반두스 매개변수의 자료형과 일치하는 자료를 전달해줘야 합니다.
