...
public class WrapperEx01 {
	...
	public static void main(String[] args) {
		...
		//실제 인스턴스에 저장된 값들의 비교
		if(i1.equals(i2)) System.out.println("i과 i2가 값이 같습니다.(equals)");
		else System.out.println("i1과 i2가 값이 다릅니다.(equals)");
		System.out.println("i1.equals(i2)="+i1.equals(i2));
		
		System.out.println("i1.compareTo(i2)="+i1.compareTo(i2));
		// 실제 인스턴스에 저장된 값들의 비교 - 뺄셈연산으로 비교 앞에 숫자가 크면 양수 뒤에 숫자가 크면 음수반환
		// 같으면 0 반환
		...
		System.out.println("inti2 + i3 = " +inti3);   ///--- 굳이 왜 Integer 를 쓰나??? 참조형으로 쓰나??  자바의 단점 double integer 이런 클래스가 없어서 불편했는데 만들어줌
