...
public class Formatter04 {
	...
	public static void main(String[] args) throws ParseException {
		...
		String r= MessageFormat.format(msg, value); //메시지 포맷의 메서드에 의한 배열 병합 작업
		System.out.println(r);
		
		
		String tableName ="CUST_INFO";
		msg = "INSERT INTO CUST_INFO VALUES (''{0}'', ''{1}'', {2}, ''{3}'');";  /// 여기가 작은 따옴표 2개
		...
		for (int i=0; i<data.length; i++) {
			Object[] objs = mf.parse(data[i]);   ///--- throws ParseException 이 생긴다 나중에 설명 함
															  ///--- 저거 나오기전에 mf.parse(data[i]) 빨간줄
