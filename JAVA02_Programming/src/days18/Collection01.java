...
// 2. 리스트(List)
// - 크개의 제약없이 데이터를 저장할 수 있음, 데이터의 삽입과 삭제에 최적화
...
// 위와 같은 동작 배열을 구현하고 있는 클래스들 -Vector, ArrayList(가장 많이 사용)
...
public class Collection01 {
	...
	public static void main(String[] args) {
		...
		v.add(20);
		v.add(30);
		// 데이터의 저장은 add 로 저장하여 데이터의 레퍼런스 값을 저장합니다.  ///--- (integer 형태로 들어간다)
		a.add(10);
		a.add(20);
		a.add(30);
		...
		a.set(2, 100); //인덱스 매개변수를 추가하여 데이터 삽입 가능 - set 는 기존값을 지우고 대입
		System.out.println();
		for(int i = 0 ; i<a.size(); i++)
			System.out.printf("v[%d] = %d\t\t",i,a.get(i));
