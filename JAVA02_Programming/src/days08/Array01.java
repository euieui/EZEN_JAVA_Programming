...
public class Array01 {
	...
	public static void main(String[] args) {
		// 배열
		// 동일한 변수 이름에 번호(첨자)를 붙여서 다수개의 데이터를 한번에 
		// 저장 할 수 있는 방법
		...
		//자료형 [] 배열 변수명
		int [] a;
		// 현재는 배열에 정수를 몇개 저장할 수 있는지 갯수가 정해지지 않았습니다.
		// 갯수는 반드시 정해놓고 사용합니다.  갯수정하지 않고 사용하지 않습니다.
		
		// 위의 내용중 변수 a는 저장될 정수들의 공간이 아니라, 정수들은 별도의 공간에
		// 저장하고 그 시작 주소를 저장하는 레퍼런스(참조) 변수 ---> string     heap 영역    
		//                                                                                     stack 
		...
		// 프로그램의 구동중에 HEAP 메모리에 공간을 생성하는 연산자로 생성된 메모리의
		// 참조(주소)값을 반환전달합니다
		// 위의 코드는 HEAP 메모리에 12Byte (정수3개) 공간을 생성하고, 해당 위치값을
		// a 배열 참조변수에 대입합니다.
