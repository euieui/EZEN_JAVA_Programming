...
public class IO07 {
	...
	public static void main(String[] args) throws IOException {
		...
		File d = new File("D:\\JAVA\\Java_se\\temp");
		...
		if (d.exists()) {
			...
			// mkdirs : 최종 타겟 이전의 경로가 존재 하지 않아도 전체 경로를 생성
		}
		
		File f = new File(d, "msg.txt");
		// File f = new File("D:\\JAVA\\Java_se\\temp\\msg.txt");
		// 이와 같이 한번에 폴더와 파일명을 설정할 수 있으나 폴더가 없을수 있기 때문에 폴더 확인 절차를
		// 거치고 파일을 설정합니다.
