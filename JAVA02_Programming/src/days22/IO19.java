...
// CalculatorResult 클래스는 toString 메소드를 통해서 연산식과 견과를 출력할 수 있습니다.
...
public class IO19 {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		String operator;
		double result = 0;	
		// 반복문을 활용하여 사용자가 종료를 원할때까지 계산을 수행하고 history 리스트에 저장합니다.
		ArrayList<CalculatorResult> history = new ArrayList<>();
		// 화면 입력을 위한 입력 스트림 생성
		BufferedReader in = new BufferedReader(new InputStreamReader(System.in));
		while(true) {
			// 좌항입력
			System.out.print("좌항입력 : ");
			...
			char isExit = in.readLine().trim().charAt(0); // 뭔소리야 이게
			if(isExit == 'y' || isExit =='Y') break;
		}
		// history 를 파일에 저장 파일 이름은 오늘 날자 2021_08_13_18_21.dat
